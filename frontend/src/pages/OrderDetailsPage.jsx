...
const OrderDetailsPage = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto p-4 sm:p-6'>
        <h2 className='text-2xl md:text-xl font-bold mb-6'>Order Details</h2>
        {!orderDetails ?
        ...
        (<div className='p-4 sm:p-6 rounded-lg border'>
                            ...
                            key={item.productId} className='border-b'>
                                <td className='py-2 px-4 flex items-center'>
                                    <img
                                     src={item.image} 
                                     alt={item.name} 
                                     className='w-12 h-12object-cover rounded-lg mr-4' 
                                     />
            ...
            {/**BAck t0 Order-Link */}
            <Link to="/my-orders" className='text-blue-500 hover:underlinw'>
